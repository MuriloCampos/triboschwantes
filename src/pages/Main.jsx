      ...
      <div tw="p-5">
        ...
        <div tw="border border-gray-300 rounded-sm bg-white">
          ...
          <div tw="flex flex-col items-center px-4 text-white mb-3">
            ...
            <a href="https://drive.google.com/uc?export=download&id=1lX7fVAW3oO-EjVA4d4PsXFUCvYP97G9I" tw="bg-blue-700 w-full p-2 rounded-sm font-semibold text-center">Volume 2<br></br>A árvore genealógica da tribo no Brasil</a>
          </div>
        </div>

        <h1 id="Registros" tw="text-2xl font-bold my-4">Registros dos Schwantes no Brasil</h1>

        <div tw="flex flex-col border border-gray-300 rounded-sm bg-white text-white px-4 py-3">
          <a href="https://drive.google.com/uc?export=download&id=1-T6db1CBdqLXWURhiO812CbXBR5NigEb" tw="bg-blue-700 mb-3 w-full p-2 rounded-sm font-semibold text-center">O diário do Augusto</a>
          <a href="https://drive.google.com/uc?export=download&id=1hOSWyZbo1ckiOIAZIO583QCR97QrRIti" tw="bg-blue-700 w-full p-2 rounded-sm font-semibold text-center">As memórias do Arlindo</a>
        </div>
      </div>
